...
[_QWERTY] = LAYOUT_ortho_4x12( \
   ...
   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LO(SPC), RZ(BSPC), LO(TAB), RZ(ENT), KC_MPLY,  ROT_A,   ROT_B,    KC_D     \
),
...
[_PLOVER] = LAYOUT_ortho_4x12( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, STN_A,   STN_O,   STN_E,   STN_U,   KC_MPLY, ROT_A,   ROT_B,   KC_D    \
),
...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  _______, _______, _______, _______, UNLOWER, RAISE,   UNLOWER, RAISE,    KC_MSTP,    ROT_A,   ROT_B,   KC_D    \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_0,    KC_6,    KC_7,    KC_8,    KC_9,    KC_DEL, \
  KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, _______, _______, _______, \
  _______, _______, _______, _______, LOWER,   UNRAISE, LOWER,   UNRAISE, KC_MSEL, ROT_A,   ROT_B,   KC_D    \
),
...
[_ADJUST] =  LAYOUT_ortho_4x12( \
  _______, MAGIC_TOGGLE_NKRO, _______, _______, _______, _______, _______, PLOVER,  _______, _______, MAGIC_TOGGLE_NKRO, KC_DEL,  \
  _______, RESET,             _______, _______, _______, _______, _______, PLOVER,  _______, _______, RESET,             _______, \
  _______, RESET,             _______, _______, _______, _______, _______, PLOVER,  _______, _______, RESET,             _______, \
  _______, _______,           _______, _______, _______, _______, _______, _______, KC_EJCT, ROT_A,   ROT_B,             KC_D     \
)
